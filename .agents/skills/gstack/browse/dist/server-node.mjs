...
?좑툘  Cookies stored in plaintext. Delete when no longer needed.`;
      }
      if (action === "load") {
...
(function() {
  ...
  function showBanner(msg, type, retryFn) {
    ...
    html += '<button class="banner-close" id="banner-close">횞</button>';
  ...
  function renderSourceDomains() {
    ...
    $sourceFooter.textContent = totalDomains + ' domains 쨌 ' + totalCookies.toLocaleString() + ' cookies';
  ...
  function renderImported() {
    ...
    $importedFooter.textContent = entries.length + ' domains 쨌 ' + totalCookies.toLocaleString() + ' cookies imported';
